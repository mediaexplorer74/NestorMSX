...
// Type: Konamiman.Z80dotNet.BeforeInstructionFetchEventArgs
...
namespace Konamiman.Z80dotNet
{
  ...
  {
    public BeforeInstructionFetchEventArgs(IExecutionStopper stopper) => this.ExecutionStopper = stopper;
